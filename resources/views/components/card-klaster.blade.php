            ...
            <div class="bg-white rounded-lg p-4 shadow border border-gray-100">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
                    <div class="flex gap-2 flex-wrap">
                        <span class="bg-blue-600 text-white px-2 py-1 rounded-full font-semibold">
                            {{ $poin['terpenuhi'] }}
                        </span>
                        <span class="bg-green-500 text-white px-2 py-1 rounded-full font-semibold">
                            {{ $poin['nilai'] }}
                        </span>
                        <span class="bg-gray-700 text-white px-2 py-1 rounded-full font-semibold">
                            Maks {{ $poin['maksimal'] }}
                        </span>
                    </div>
