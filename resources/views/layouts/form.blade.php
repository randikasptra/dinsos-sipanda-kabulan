    ...
    @section('content')
        <div class="max-w-4xl mx-auto p-6 bg-white rounded-2xl shadow-lg space-y-6">
            ...
            <div class="text-blue-800 border-b pb-4">
                ...
                <p class="text-sm mt-1 text-gray-500">Silakan isi pertanyaan di bawah dengan benar dan unggah dokumen
                    pendukung</p>
            </div>

            <!-- Pertanyaan -->
            <div class="space-y-4">
                <p class="text-gray-700 font-semibold">Apakah tersedia peraturan daerah terkait penyelenggaraan
                    Kabupaten/Kota Layak Anak?</p>
            ...
            </div>resources/views/form.blade.php
